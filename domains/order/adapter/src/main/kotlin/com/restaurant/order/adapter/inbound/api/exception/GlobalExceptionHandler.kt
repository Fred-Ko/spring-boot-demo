package com.restaurant.order.adapter.inbound.api.exception
...
class GlobalExceptionHandler {
  ...
  fun handleNoSuchElementException(e: NoSuchElementException): ProblemDetail {
    return ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, e.message ?: "리소스를 찾을 수 없습니다.")
            .apply {
  ...
  fun handleIllegalArgumentException(e: IllegalArgumentException): ProblemDetail {
    return ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, e.message ?: "잘못된 요청입니다.")
            .apply {
  ...
  fun handleValidationExceptions(e: MethodArgumentNotValidException): ProblemDetail {
    ...
    return ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, "입력값 검증에 실패했습니다.").apply {
